    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col flex-nowrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            >
              <a href="index.html" className="flex items-center gap-8" >
                  <Image
                    width={110}
                    height={80}
              ...
              <ul className="flex items-center gap-5">
                <li>
                  <a href="#" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-orange-700"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
